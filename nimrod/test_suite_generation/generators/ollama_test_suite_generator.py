...
class OllamaTestSuiteGenerator(TestSuiteGenerator):
    ...
    def __init__(self, java_tool, model_key: str = "ollama", model_config: Dict[str, Any] = None):
        ...
        logging.info(f"Inicializado {self.model_key} com template: {self.prompt_template}")
    ...
    def _process_single_prompt(self, messages: List[Dict[str, str]], test_template: str, output_path: str, branch: str,
        ...
        total_duration = self.api.timeout_seconds * 1_000_000_000  # Initialize with timeout value in nanoseconds
        try:
